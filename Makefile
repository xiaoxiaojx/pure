...
start_demo:
	g++ test-demo/*.cc -g -I deps/v8/include/ -I deps/uv/include/ -o pure_test -L liba/ -lv8_monolith -luv_a -pthread -std=c++17 -DV8_COMPRESS_POINTERS -DV8_ENABLE_SANDBOX && ./pure_test